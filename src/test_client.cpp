...
void * init(){
    return engine_init(nullptr, nullptr, 0, "/home/yuki/CLionProjects/pbd/src/aep", "/mnt/disk/");
}
...
//    engine_deinit(ctx);
//    ctx = engine_init(nullptr, nullptr, 0, "/home/yuki/CLionProjects/pbd/src/aep", "/mnt/disk/");
//    char res[2000*128];
...
char *peer_host_info[] = {"127.0.0.1:3001"};
int main() {
    int numThread = 100;
    int numUser = 10000;
    int tot = 0;
    ...
    void *ctx = engine_init("127.0.0.1:3000", peer_host_info, 1, "/home/yuki/test/", "/home/yuki/test2/");
    int num = numUser / numThread;
    cout << "writing data!" << endl;
    milliseconds start = Now();
//    for (int i = 0; i < numThread; i++) {
//        t[i] = thread(&write, i * num, i * num + num - 1, ctx);
//    }
//    for (int i = 0; i < numThread; i++) {
//        t[i].join();
//    }
    ...
    //while(1);
//    engine_deinit(ctx);
//    ctx = engine_init("127.0.0.1:3000", peer_host_info, 1, "/home/yuki/test/", "/home/yuki/test2/");
    start = Now();
    cout << "reading data!" << endl;
    for (int i = 0; i < numThread; i++) {
        t[i] = thread(&read, ctx, num, num * numThread, re[i]);
    }
    for (int i = 0; i < numThread; i++) {
        t[i].join();
    }
